...
export type OneRosterCsvPackageDiagnosticCode =
  ...
  | "semantic.resource_role_mismatch"
  | "semantic.result_class_mismatch"
  | "semantic.result_student_not_enrolled"
  | "semantic.score_above_max"
  | "semantic.score_below_min"
  | "semantic.user_profile_user_mismatch"
  | "semantic.user_resource_class_org_mismatch"
